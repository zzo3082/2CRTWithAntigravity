function AoI = compute_aoi_periodic(Is, C_idx, user_idx, K, L)
    user_seq = Is{C_idx(user_idx)};
    pK = build_2CRT(K); % Next prime
    pK = next_prime(K);
    
    % Since Formulas (29) (32) (33) are exactly the expected system delay for MPR=2,
    % we can calculate the exact AoI using renewal theory distributions.
